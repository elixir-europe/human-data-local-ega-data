...
public abstract class ServiceTemplate implements Service {
    ...
    protected JSONObject responseSection(String[] arr) throws JSONException {
        ...
        response.put("numTotalResults", 1); // -- Result = Always 1 Array
    ...
    protected JSONObject responseSection(Map<String,String> arr) throws JSONException {
        JSONObject response = new JSONObject();

        response.put("numTotalResults", 1); // -- Result = Always 1 Object
        response.put("resultType", "us.monoid.json.JSONObject");
    ...
    protected JSONObject responseSection(List<Map<String,String>> arr) throws JSONException {
        JSONObject response = new JSONObject();

        response.put("numTotalResults", 1); // -- Result = Always 1 Object
        response.put("resultType", "us.monoid.json.JSONObject");
        
        JSONArray mJSONArray = arr!=null?new JSONArray(arr):new JSONArray();        
        response.put("result", mJSONArray);
